  ...
  const guardingServices = [
    {
      ...
      icon: '🛡️',
      description:
        '24/7 manned guarding services for permanent security presence at your premises',
      features: [
    ...
    },
    {
      ...
      icon: '🚔',
      description:
        'Randomized armed patrols to maintain security visibility across multiple sites',
      features: [
  ...
  const securityFeatures = [
    {
      ...
      description:
        'All personnel are vetted and licensed under the Private Security Regulation Act (PSRA).',
    },
    {
      icon: <FaClipboardCheck className="feature-icon" />,
      title: 'Rigorous 3-Step Screening',
      description:
        'Includes criminal background checks, psychometric testing and professional vetting.',
    },
    {
      icon: <FaChalkboardTeacher className="feature-icon" />,
      title: 'Ongoing Training',
      description:
        'Monthly refresher courses ensure our guards stay up to date with latest protocols.',
    },
    {
      icon: <FaFingerprint className="feature-icon" />,
      title: 'Biometric & Real-Time Tech',
      description:
        'Integrated systems provide live reporting and smart surveillance for accountability.',
    },
  ];
  ...
  return (
    <div className="security-guarding-page">
      ...
      <section className="guarding-intro container">
        ...
        <p>
          As a licensed security provider under the Private Security Regulatory Authority,
          Exlent Touch Security Services offers:
        </p>
      ...
      <section className="service-types container">
      ...
      <section className="coverage-section container">
        ...
        <div className="coverage-content">
          ...
          <div className="coverage-list">
            ...
            <p>
              <MdPhone className="icon phone-icon" /> 24/7 Emergency Response:{' '}
